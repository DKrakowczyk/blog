...
const Cover = styled.span`
  background-image: url(http://ghost.estudiopatagon.com/breek/content/images/size/w700h500/2019/05/480016-PGKTGR-852-1.jpg);
  display: block;
  height: 300px;
...
export const ArtcleBoxShort = props => {
